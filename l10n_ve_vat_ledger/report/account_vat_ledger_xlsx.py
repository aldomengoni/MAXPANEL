            ...
            for idx, invoice in enumerate(invoices):
                if obj.type == 'purchase':
                    ...
                    if invoice.move_type == 'in_refund' or invoice.move_type == 'out_refund':
                        move_reconcileds = invoice.invoice_payments_widget
                        inv_info = ''
                        moves = []
                        if move_reconcileds:
                            for m in move_reconcileds['content']:
                    ...
                    if invoice.state == 'cancel':
                        ...
                        if invoice.payment_group_ids:
                            ...
                            # if payments:
                            #     payments_with_igtf = payments.filtered(lambda x: x.is_igtf or x.igtf_amount_signed > 0)
