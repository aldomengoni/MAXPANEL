...
class AccountPayment(models.Model):
    ...
    is_iva_record = fields.Boolean('Is IVA record', compute='_compute_is_iva_record')

    def _compute_is_iva_record(self):
        for rec in self:
            rec.is_iva_record = 'iva' in rec.payment_method_description.lower()
